...
export const services: Service[] = [
  {
    ...
    gradient: "from-[#9D98FF] via-[#E7E5FF] to-white",
  },
  {
    ...
    gradient: "from-[#C8C5FF] via-[#F2F1FF] to-white",
  },
  {
    ...
    gradient: "from-[#B9B4FF] via-[#F1EFFF] to-white",
  },
  {
    ...
    gradient: "from-[#D8D6FF] via-[#F1EFFF] to-white",
  },
  {
    ...
    gradient: "from-[#ADA7FF] via-[#F2F1FF] to-white",
  },
  {
    ...
    gradient: "from-[#D8D6FF] via-[#F2F1FF] to-white",
  },
];
