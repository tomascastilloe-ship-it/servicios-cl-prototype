...
const requirements = [
  ...
  "Aceptar que la coordinación inicial y reservas ocurren dentro de servicios.cl.",
];
      ...
      <section className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[1fr_430px] lg:items-center">
          ...
          <div className="rounded-[2rem] bg-neutral-950 p-6 text-white shadow-xl sm:p-8">
            <p className="text-sm font-black uppercase tracking-[0.18em] text-rose-300">Panel del profesional</p>
            <div className="mt-5 rounded-[1.5rem] bg-white p-5 text-neutral-950">
              <p className="text-sm font-bold text-neutral-500">Calendario semanal</p>
              <div className="mt-4 grid gap-2">
                {["Lunes 09:00–13:00", "Martes 15:00–19:00", "Jueves 10:00–16:00"].map((slot) => (
                  <div key={slot} className="rounded-xl border border-neutral-200 px-4 py-3 text-sm font-black">
                    {slot}
                  </div>
                ))}
              </div>
        ...
        <section className="mt-10 rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-neutral-200 sm:p-10">
          <div className="grid gap-8 lg:grid-cols-2">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.2em] text-[#ff385c]">Requisitos</p>
            ...
            <div className="rounded-[1.7rem] bg-rose-50 p-6">
              <h3 className="text-2xl font-black text-[#d70466]">Formulario próximo</h3>
